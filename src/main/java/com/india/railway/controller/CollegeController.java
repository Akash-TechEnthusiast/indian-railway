...
public class CollegeController {
     ...
     * 
     * @GetMapping("/byName")
     * public Page<College> getCollegeByName(@RequestParam(name = "name") String
     * name,
     * 
     ...
     * public College addBookToAuthor(@PathVariable Long collgeId, @PathVariable
     * Long departmentId) {
     * return collegeService.addDepartmentToCollege(collgeId, departmentId);
     * }
     * 
     * @DeleteMapping("/{authorId}/books/{bookId}")
     * public College removeDepartmentFromCollege(@PathVariable Long
     * collgeId, @PathVariable Long departmentId) {
